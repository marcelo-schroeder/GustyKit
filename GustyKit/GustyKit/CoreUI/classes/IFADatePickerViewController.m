...
-(NSArray*)IFA_datePickerToolbarItemsForProperty:(NSString *)a_propertyName inObject:(NSObject *)a_object target:(id)a_target{
    ...
    if (l_showResetCountDownButton) {
        UIBarButtonItem *l_resetCountDownButton = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringFromTable(@"Set To Zero", @"GustyKitLocalizable", nil)
...
//        l_resetCountDownButton.accessibilityLabel = @"Set To Zero";
    ...
    if (l_showClearDateButton || l_showSelectDistantPastButton || l_showSelectDistantFutureButton) {
        ...
        if (l_showClearDateButton) {
            UIBarButtonItem *clearDateButton = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringFromTable(@"Clear Date", @"GustyKitLocalizable", nil)
                                                                                style:UIBarButtonItemStylePlain
                                                                               target:a_target
...
//            clearDateButton.accessibilityLabel = @"Clear Date";
        ...
        if (l_showSelectDistantPastButton) {
            UIBarButtonItem *l_selectDistantPastButton = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringFromTable(@"Distant Past", @"GustyKitLocalizable", nil)
                                                                                          style:UIBarButtonItemStylePlain
                                                                                         target:a_target
...
//            l_selectDistantPastButton.accessibilityLabel = @"Distant Past";
        ...
        if (l_showSelectDistantFutureButton) {
            UIBarButtonItem *l_selectDistantFutureButton = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringFromTable(@"Distant Future", @"GustyKitLocalizable", nil)
                                                                                            style:UIBarButtonItemStylePlain
                                                                                           target:a_target

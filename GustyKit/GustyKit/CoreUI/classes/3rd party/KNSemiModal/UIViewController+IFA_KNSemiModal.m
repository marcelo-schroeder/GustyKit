...
static UIViewController *c_semiModalViewController;
static BOOL c_presentedInLandscapeInterfaceOrientation;
...
//    NSLog(@"presentSemiModalViewController: %@, by: %@", [vc description], [self description]);
    ...
    c_semiModalViewController = vc;
    c_semiModalViewController.presentedAsSemiModal = YES;
...
//        [overlay addSubview:ss];
        ...
        c_presentedInLandscapeInterfaceOrientation = [IFAUIUtils isDeviceInLandscapeOrientation] ;
...
- (void)dismissSemiModalViewWithCompletionBlock:(void (^)())a_completionBlock {
    ...
    [UIView animateWithDuration:kSemiModalAnimationDuration animations:^{
        ...
        c_semiModalViewController.presentedAsSemiModal = NO;
        c_semiModalViewController = nil;
...
+ (BOOL)semiModalViewPresentedInLandscapeInterfaceOrientation {
    return c_presentedInLandscapeInterfaceOrientation;
}

+ (UIViewController *)semiModalViewController {
    return c_semiModalViewController;
}

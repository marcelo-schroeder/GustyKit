...
@interface IFA_ECSlidingViewController ()
...
- (IFA_ECSlidingViewController *)slidingViewController
{
  UIViewController *viewController = self.parentViewController;
  while (!(viewController == nil || [viewController isKindOfClass:[IFA_ECSlidingViewController class]])) {
    viewController = viewController.parentViewController;
  }
  
  return (IFA_ECSlidingViewController *)viewController;
}

@end

@implementation IFA_ECSlidingViewController

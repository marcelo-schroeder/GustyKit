...
/**
* Help text for section obtained from GustyKitHelpLocalizable.strings.
* GustyKitHelpLocalizable.strings entry key format:
...
/**
* Help text for property obtained from GustyKitHelpLocalizable.strings.
* GustyKitHelpLocalizable.strings entry key format at property level:
*   entities.<entityName>.properties.<propertyName>.description
* GustyKitHelpLocalizable.strings entry key format at property value level:
...
/**
* Help text for empty list obtained from GustyKitHelpLocalizable.strings.
* GustyKitHelpLocalizable.strings entry key format:
...
/**
* Help text for view controllers obtained from GustyKitHelpLocalizable.strings.
...
/**
* Provides the key prefix used for persistent entity related entries in GustyKitHelpLocalizable.strings.

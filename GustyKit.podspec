Pod::Spec.new do |s|
    ...
    s.platform          = :ios, '8.0'
    s.requires_arc      = true
    s.source            = { :git => 'https://github.com/marcelo-schroeder/GustyKit.git', :tag => 'v1.0.1' }
    ...
    s.subspec 'FlurrySupport' do |ss|
        ss.source_files  = 'GustyKit/GustyKit/FlurrySupport/classes/**/*.{h,m}'
        ss.xcconfig      = { 'GCC_PREPROCESSOR_DEFINITIONS' => 'IFA_AVAILABLE_FlurrySupport=1' }
        ss.dependency 'GustyKit/CoreUI'
        ss.dependency 'FlurrySDK'
    end
    s.subspec 'Html' do |ss|
        ss.source_files  = 'GustyKit/GustyKit/Html/classes/**/*.{h,m}'
        ss.resource      = 'GustyKit/GustyKit/Html/resources/**/*.*'
